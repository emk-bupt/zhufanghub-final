...
import CreateModal from "../modals/create-modal/CreateRoomModal";
...
const CompanyNavbar = () => {
  ...
  return (
    <div className="sticky top-0 left-0 w-full flex justify-between items-center z-40 px-4 py-2">
      <Link href="/company/dashboard" className="flex items-center gap-2 transition-all">
        <h1 className="text-blue-600 text-2xl font-bold">住房Hub公司管理系统</h1>
      </Link>
