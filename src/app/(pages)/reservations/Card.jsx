...
const Card = ({ reservation, mutate }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all transform hover:scale-105 duration-300 flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        ...
        <button
          ...
          className={`w-full py-2 mt-4 rounded-xl transition-all 
            ${isLoading ? 'bg-gray-500 dark:bg-gray-600 cursor-not-allowed' : 'bg-red-600 dark:bg-red-600 text-white hover:bg-red-500 dark:hover:bg-red-500'}
